<?= view('templates/header', ['title' => 'Profil Admin']) ?>
...
<style>
    ...
    body.dark-mode .profil-avatar-ring{ background: radial-gradient(circle, rgba(139,92,246,.18) 0%, rgba(139,92,246,0) 70%); }
    body.dark-mode .badge-admin{ background: rgba(139,92,246,.15); color: #a78bfa; }
    ...
    body.dark-mode .info-row .icon{ background: rgba(139,92,246,.12); color: #a78bfa; }
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <div>
        <h1 class="h2 mb-0">Profil Admin</h1>
...
<div class="row g-3 mb-3">
    ...
    <div class="col-md-4">
        <div class="profil-hero">
            ...
            <span class="badge-admin"><i class="bi bi-shield-lock-fill"></i> ADMINISTRATOR</span>
...
<div class="row g-3 mb-3">
    ...
    <div class="col-6 col-md-3">
        <div class="mini-stat-card stat-green">
            ...
            <div class="num"><?= $penyetoran_hari ?></div>
            <div class="lbl">Penyetoran Disetujui Hari Ini</div>
        </div>
    </div>
    <div class="col-6 col-md-3">
        <div class="mini-stat-card stat-orange">
            <div class="icon-wrap"><i class="bi bi-cash-coin"></i></div>
            <div class="num">Rp <?= number_format($total_pemasukan, 0, ',', '.') ?></div>
    ...
    <div class="col-6 col-md-3">
        <div class="mini-stat-card stat-purple">
            ...
            <div class="num"><?= $pending_pengajuan ?></div>
...
<div class="modal fade" id="editProfilModal" tabindex="-1">
    <div class="modal-dialog">
        <form action="<?= base_url('profil-admin/update') ?>" method="post">
